...
import type { TriggerArgs } from "./types";

export const insert = mutation({
  args: { value: v.any(), atomicInsert: v.string(), triggers: v.array(v.string()) },
  returns: v.string(),
...
export const patch = mutation({
  args: { id: v.string(), value: v.any(), atomicPatch: v.string(), triggers: v.array(v.string()) },
  returns: v.null(),
...
export const replace = mutation({
  args: { id: v.string(), value: v.any(), atomicReplace: v.string(), triggers: v.array(v.string()) },
  returns: v.null(),
...
export const deleteDoc = mutation({
  args: { id: v.string(), atomicDelete: v.string(), triggers: v.array(v.string()) },
  returns: v.null(),
